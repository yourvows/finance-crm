...
export default {
    ...
    methods: {
        ...
        async refresh() {
            ...
            this.accessoryItemSecond = this.productCodesFields.data.slice(10, this.productCodesFields.data.length);
            this.accessoryItem = this.productCodesFields.data;
        },
        editItem() {
            console.log('edited')
        },
