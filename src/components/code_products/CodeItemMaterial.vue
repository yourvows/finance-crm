...
export default {
    ...
    methods: {
        ...
        async refresh() {
            ...
            this.materialItemSecond = this.productCodesFields.data.slice(10, this.productCodesFields.data.length);
            this.materialItem = this.productCodesFields.data;
        },
        editItem() {
            console.log('edited')
        },
