...
export default {
    ...
    methods: {
        ...
        async refresh() {
            ...
            this.productItemSecond = this.productCodesFields.data.slice(10, this.productCodesFields.data.length);
            this.productItem = this.productCodesFields.data;
        },
        editItem() {
            console.log('edited')
        },
